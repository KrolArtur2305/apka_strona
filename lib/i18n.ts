...
export const i18n: Record<Locale, LocaleConfig> = {
  pl: {
    ...
    nativeName: "Polski",
    seo: {
      title: "MyBuildIQ – Aplikacja do zarządzania budową domu",
    ...
    ui: {
      ...
      bodyBudget: "Każda faktura, każdy przelew — przypisane do etapu i kategorii. Nie musisz liczyć z pamięci. MyBuildIQ pilnuje budżetu za Ciebie i ostrzega, zanim przekroczysz limit.",
      ...
      cards: [
        ...
        { icon: "🔨", title: "Budowa systemem gospodarczym", desc: "Koordynujesz kilku wykonawców jednocześnie. Każdy robi swoje — Ty musisz widzieć całość. MyBuildIQ daje Ci ten widok." },
      ...
      faqItems: [
        ...
        { question: "Mam już Excela do budżetu. Po co mi to?", answer: "Excel nie wysyła alertów gdy przekraczasz budżet. Nie przechowuje zdjęć postępów przy każdym wpisie. Nie łączy faktury z konkretnym wykonawcą i etapem. MyBuildIQ robi to wszystko." },
  ...
  en: {
    ...
    nativeName: "English",
    seo: {
      title: "MyBuildIQ – Construction Management App for Home Builders",
    ...
    ui: {
      ...
      bodyBudget: "Every invoice, every payment — assigned to a phase and category. No mental math. MyBuildIQ tracks your budget and warns you before you go over.",
      ...
      cards: [
        ...
        { icon: "🔨", title: "Self-build project", desc: "You're coordinating multiple contractors at once. Everyone does their part — you need to see the whole picture. MyBuildIQ gives you that view." },
      ...
      faqItems: [
        ...
        { question: "I already use Excel for my budget. Why do I need this?", answer: "Excel doesn't send alerts when you exceed your budget. It doesn't store progress photos with each entry. It doesn't link invoices to specific contractors and phases. MyBuildIQ does all of that." },
  ...
  de: {
    ...
    nativeName: "Deutsch",
    seo: {
      title: "MyBuildIQ – Bauprojekt Management App für Hausbau",
    ...
    ui: {
      ...
      bodyBudget: "Jede Rechnung, jede Zahlung — einer Phase und Kategorie zugeordnet. Kein Kopfrechnen mehr. MyBuildIQ verfolgt Ihr Budget und warnt Sie, bevor Sie es überschreiten.",
      ...
      cards: [
        ...
        { icon: "🔨", title: "Selbstbauprojekt", desc: "Sie koordinieren mehrere Auftragnehmer gleichzeitig. Jeder macht seinen Teil — Sie müssen das Gesamtbild sehen. MyBuildIQ gibt Ihnen diesen Überblick." },
      ...
      faqItems: [
        ...
        { question: "Ich nutze bereits Excel für mein Budget. Warum brauche ich das?", answer: "Excel sendet keine Warnungen bei Budgetüberschreitung. Es speichert keine Fortschrittsfotos bei jedem Eintrag. MyBuildIQ macht all das." },
  ...
  no: {
    ...
    nativeName: "Norsk",
    seo: {
      title: "MyBuildIQ – App for byggeprosjekt og boligbygging",
    ...
    ui: {
      ...
      bodyBudget: "Hver faktura, hver betaling — tilordnet en fase og kategori. Ingen hoderegning. MyBuildIQ sporer budsjettet ditt og advarer deg før du overskrider det.",
      ...
      cards: [
        ...
        { icon: "🔨", title: "Selvbyggprosjekt", desc: "Du koordinerer flere entreprenører samtidig. Alle gjør sin del — du trenger å se helhetsbildet. MyBuildIQ gir deg det." },
      ...
      faqItems: [
        ...
        { question: "Jeg bruker allerede Excel for budsjettet mitt. Hvorfor trenger jeg dette?", answer: "Excel sender ikke varsler når du overskrider budsjettet. Det lagrer ikke fremdriftsbilder med hver oppføring. MyBuildIQ gjør alt dette." },
  ...
  fr: {
    ...
    nativeName: "Français",
    seo: {
      title: "MyBuildIQ – Application de gestion de chantier pour particuliers",
    ...
    ui: {
      ...
      bodyBudget: "Chaque facture, chaque paiement — assigné à une phase et une catégorie. Fini les calculs mentaux. MyBuildIQ suit votre budget et vous avertit avant de dépasser.",
      ...
      cards: [
        ...
        { icon: "🔨", title: "Autoconstruction", desc: "Vous coordonnez plusieurs entrepreneurs simultanément. Chacun fait sa part — vous devez voir l'ensemble. MyBuildIQ vous donne cette vue." },
      ...
      faqItems: [
        ...
        { question: "J'utilise déjà Excel pour mon budget. Pourquoi en ai-je besoin ?", answer: "Excel n'envoie pas d'alertes quand vous dépassez votre budget. Il ne stocke pas de photos d'avancement avec chaque entrée. MyBuildIQ fait tout cela." },
